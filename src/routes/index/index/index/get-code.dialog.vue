        ...
        <div class="layer">
            ...
            <div class="content">
                <div class="form-group">
                    <input class="form-control" @blur="inputBlur()" @input="clearErrorText()" v-model="formData.phone"
                           type="text"
                           title="input" placeholder="请输入手机号" maxlength="11">
                </div>
                <div class="form-group msg-code">
                    <input class="form-control" @blur="inputBlur()" @input="clearErrorText()" v-model="formData.msgCode"
                           type="text"
                           title="input"
                           placeholder="请输入短信验证码" maxlength="6">
                    <button class="get-msg-code btn" :class="{ disable: msgCodeBtnDisable }" @click="getMsgCode()">{{
                        msgCodeBtnText }}
                    </button>
                </div>
            ...
            <footer>
                <button class="btn primary" :class="{ disable: isSubmitting }" @click="okBtnClick()">{{ submitBtnText
                    }}
                </button>
...
<script lang="ts">
    ...
    export default class GetCodeDialog extends Vue {
        ...
        get msgCodeBtnText (): string {
            ...
            return countdownNo === this.defaultCountDownNo ? '获取验证码' : countdownNo + ' s'
        }
        ...
        .layer {
            ...
            & > footer {
                ...
                .btn.close {
                    ...
                    width: 0.6rem;
                    height: 0.6rem;
                    background: transparent url('../../../../assets/images/common-icon/close.png') center / 100% 100% no-repeat;
                }
            }
        }
    }
